...
test('UMG 96RM-E test', () => {
    const device: IDevice = parse("Janitza electronics,UMG96rm,Release = 3.5,0,17023107,100,UMG96RM-E-RCM-1702-3107", "192.168.7.106");
...
test('UMG 510 test', () => {
    const device: IDevice = parse("Janitza electronics,UMG510,5,000005C0,51001443,001037,Sep 16 2009 14:33:16", "192.168.7.111");
    expect(device.ip).toBe("192.168.7.111");
